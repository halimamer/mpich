        ...
        case PUT:
            {
                ...
                origin_datatype = putop->origin_datatype;
                target_datatype = putop->target_datatype;
        ...
        case GET:
            {
                ...
                origin_datatype = getop->origin_datatype;
                target_datatype = getop->target_datatype;
