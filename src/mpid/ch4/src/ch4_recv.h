...
#undef FUNCNAME
#define FUNCNAME MPID_Recv_min
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX int MPID_Recv_min(void *buf,
                                        int count,
                                        int rank,
                                        int tag,
                                        int context_offset, MPI_Status * status)
...
#undef FUNCNAME
#define FUNCNAME MPID_Irecv_min
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX int MPID_Irecv_min(void *buf,
                                         int count,
                                         int rank,
                                         int tag,
                                         int context_offset)
