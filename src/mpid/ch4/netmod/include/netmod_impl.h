                                               ...
                                               int context_offset, MPIR_Request ** request)
{
    ...
    ret = MPIDI_NM_native_func->mpi_send_min(buf, count, rank, tag, comm, context_offset, request);
                                                ...
                                                int context_offset, MPIR_Request ** request)
{
    ...
    ret = MPIDI_NM_native_func->mpi_isend_min(buf, count, rank, tag, comm, context_offset, request);
...
MPL_STATIC_INLINE_PREFIX int MPIDI_NM_mpi_recv_min(void *buf, int count,
                                               int rank, int tag, MPIR_Comm * comm,
                                               int context_offset, MPI_Status * status,
                                               MPIR_Request ** request)
{
    ...
    ret = MPIDI_NM_native_func->mpi_recv_min(buf, count, rank, tag, comm, context_offset,
                                         status, request);
...
MPL_STATIC_INLINE_PREFIX int MPIDI_NM_mpi_irecv_min(void *buf, int count,
                                                int rank, int tag, MPIR_Comm * comm,
                                                int context_offset, MPIR_Request ** request)
{
    int ret;
    ...
    ret = MPIDI_NM_native_func->mpi_irecv_min(buf, count, rank, tag, comm, context_offset, request);
