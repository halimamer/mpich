...
#undef FUNCNAME
#define FUNCNAME MPIDI_OFI_recv_event_byte
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX int MPIDI_OFI_recv_event_byte(struct fi_cq_tagged_entry *wc,
                                                       MPIR_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
    MPI_Aint last;
...
#undef FUNCNAME
#define FUNCNAME MPIDI_OFI_send_event_byte
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX int MPIDI_OFI_send_event_byte(struct fi_cq_tagged_entry *wc,
                                                  MPIR_Request * sreq)
{
    int c;
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_NETMOD_OFI_SEND_EVENT_BYTE);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_NETMOD_OFI_SEND_EVENT_BYTE);
                                                         ...
                                                         MPIR_Request * req, int buffered)
{
    ...
    else if (likely(MPIDI_OFI_REQUEST(req, event_id) == MPIDI_OFI_EVENT_SEND_BYTE)) {
        mpi_errno = MPIDI_OFI_send_event_byte(wc, req);
        goto fn_exit;
    }
    ...
    else if (likely(MPIDI_OFI_REQUEST(req, event_id) == MPIDI_OFI_EVENT_RECV_BYTE)) {
        mpi_errno = MPIDI_OFI_recv_event_byte(wc, req);
        goto fn_exit;
    }
